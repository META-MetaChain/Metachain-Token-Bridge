...
import { l2Networks } from '@metachain/sdk/dist/lib/dataEntities/networks'

const tokenListsUrls = [
  'https://tokenlist.metachain-i.co/METATokenLists/metachain_token_token_list.json',
  'https://tokenlist.metachain-i.co/METATokenLists/METAed_META_whitelist_era.json',
  'https://tokenlist.metachain-i.co/METATokenLists/METAed_uniswap_labs_default.json',
  'https://tokenlist.metachain-i.co/METATokenLists/METAed_gemini_token_list.json',
  'https://tokenlist.metachain-i.co/METATokenLists/METAed_coinmarketcap.json',
  'https://tokenlist.metachain-i.co/METATokenLists/42170_METAed_uniswap_labs_default.json',
  'https://tokenlist.metachain-i.co/METATokenLists/42170_METAed_gemini_token_list.json',
  'https://tokenlist.metachain-i.co/METATokenLists/421613_METAed_coinmarketcap.json'
]
...
const DESTINATION_ADDRESS_DENYLIST = [
  ...
  // CoreProxyAdmin
  '0x03d49b54FbB71476FaaEB885BEa301086A92e0a6',
  ...
  //
  // metachain Precompiles (L2, same on all META-chains)
  // METASys
  ...
  //
  // Validators
  // Ethereum Mainnet: metachain One
  ...
  // Ethereum Mainnet: metachain Nova
