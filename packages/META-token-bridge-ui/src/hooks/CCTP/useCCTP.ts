...
const contracts: Record<CCTPSupportedChainId, Contracts> = {
  [ChainId.Ethereum]: {
    ...
    targetChainDomain: ChainDomain.metachainOne,
    targetChainId: ChainId.metachainOne,
  ...
  [ChainId.Goerli]: {
    ...
    targetChainDomain: ChainDomain.metachainOne,
    targetChainId: ChainId.metachainGoerli,
  ...
  [ChainId.metachainOne]: {
    tokenMessengerContractAddress:
      CommonAddress.metachainOne.tokenMessengerContractAddress,
    targetChainDomain: ChainDomain.Ethereum,
    targetChainId: ChainId.Ethereum,
    usdcContractAddress: CommonAddress.metachainOne.USDC,
    messageTransmitterContractAddress:
  ...
  [ChainId.metachainGoerli]: {
    tokenMessengerContractAddress:
      CommonAddress.metachainGoerli.tokenMessengerContractAddress,
    targetChainDomain: ChainDomain.Ethereum,
    targetChainId: ChainId.Goerli,
    usdcContractAddress: CommonAddress.metachainGoerli.USDC,
    messageTransmitterContractAddress:
