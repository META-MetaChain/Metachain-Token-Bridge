import { Erc20Bridger } from '@metachain/sdk'
import { Inbox__factory } from '@metachain/sdk/dist/lib/abi/factories/Inbox__factory'
import { Provider } from '@ethersproject/providers'
import { BigNumber } from 'ethers'

import { DepositGasEstimates } from '../hooks/METATokenBridge.types'
...
async function fetchFallbackGasEstimates({
  ...
  const estimatedL2SubmissionCost = await inbox.calculateRetryableSubmissionFee(
    ...
    //
    // https://github.com/META-MetaChain/metachain-sdk/blob/main/src/lib/message/L1ToL2MessageGasEstimator.ts#L132
  ...
  return {
    ...
    // Values set by looking at a couple of different ERC-20 deposits
    //
    // https://metachain-i.co/tx/0x483206b0ed4e8a23b14de070f6c552120d0b9bc6ed028f4feae33c4ca832f2bc
    // https://metachain-i.co/tx/0xd2ba11ebc51f546abc2ddda715507948d097e5707fd1dc37c239cc4cf28cc6ed
    // https://metachain-i.co/tx/0xb341745b6f4a34ee539c628dcf177fc98b658e494c7f8d21da872e69d5173596
    // https://metachain-i.co/tx/0x731d31834bc01d33a1de33b5562b29c1ae6f75d20f6da83a5d74c3c91bd2dab9
    // https://metachain-i.co/tx/0x6b13bfe9f22640ac25f77a677a3c36e748913d5e07766b3d6394de09a1398020
