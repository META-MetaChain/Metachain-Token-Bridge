...
} from '../components/MainContent/ExploremetachainContent'
import {
...
const AnalyticsNetworkNames = ['metachain One', 'metachain Nova'] as const
...
type AnalyticsEventMap = {
  ...
  'Explore: DeFi Project Click': { project: ExploremetachainDeFiProjectName }
  'Explore: NFT Project Click': { project: ExploremetachainNFTProjectName }
  'Fast Bridge Click': {
    bridge:
      | FastBridgeName
  ...
  'Use metachain Bridge Click': { tokenSymbol: NonCanonicalTokenName | 'USDC' }
