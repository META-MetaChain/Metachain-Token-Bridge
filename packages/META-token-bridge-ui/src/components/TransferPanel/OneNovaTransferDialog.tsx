...
export function OneNovaTransferDialog(
  ...
  const sourceNetworkSlug =
    sourceChainId === ChainId.metachainOne ? 'metachain' : 'nova'
  const destinationNetworkSlug =
    destinationChainId === ChainId.metachainOne ? 'metachain' : 'nova'
          ...
          <Tab.Panel className="flex flex-col space-y-3 px-8 py-4">
            <div className="flex flex-col space-y-3">
              <p className="font-light">
                Use a third party bridge to transfer funds between metachain One
                and metachain Nova.
              </p>
            </div>
