...
function getCalendarUrl(
  ...
  return `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${title}&dates=${parsedWithdrawalDate}&details=Withdrawn+on+%3Ca%20href=%22https://bridge.metachain-i.co%22%3Ehttps://bridge.metachain-i.co%3C/a%3E`
}
...
export function WithdrawalConfirmationDialog(
  ...
  const from = isConnectedTometachain ? l2.network : l1.network
  const to = isConnectedTometachain ? l1.network : l2.network
  ...
  const { ismetachainOne, isOrbitChain } = isNetwork(l2.network.id)
      ...
      <div className="flex flex-col md:min-w-[725px] md:max-w-[725px]">
        <Tab.Group>
          <div className="flex flex-row items-center justify-between bg-ocl-blue px-8 py-4">
            ...
            <button className="META-hover" onClick={() => closeWithReset(false)}>
              <XMarkIcon className="h-6 w-6 text-white" />
            </button>
          </div>

          <Tab.List className="bg-ocl-blue">
            {ismetachainOne && <TabButton>Use a third-party bridge</TabButton>}
            <TabButton>Use metachain’s bridge</TabButton>
          </Tab.List>
              ...
              <div className="flex flex-col space-y-3">
                ...
                <div className="flex flex-row items-center space-x-1">
                  ...
                  <span className="font-medium text-orange-dark">
                    Security not guaranteed by metachain
                  </span>
                </div>
              </div>
                ...
                <div className="flex flex-col justify-center space-y-2.5 rounded bg-cyan py-4 align-middle ">
                  ...
                  <div className="flex justify-center">
                    <ExternalLink
                      ...
                      className="META-hover flex space-x-2 rounded border border-ocl-blue px-4 py-2 text-ocl-blue"
                    >
                      <Image
