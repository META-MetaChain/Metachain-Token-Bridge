...
export function DepositCardCreationFailure({ tx }: { tx: MergedTransaction }) {
  ...
  return (
    <DepositCardContainer tx={tx}>
      ...
      <button
        className="META-hover flex max-w-md flex-row items-center justify-between rounded-xl border border-brick-dark px-6 py-4"
      ...
      <ExternalLink
        href={GET_HELP_LINK}
        className="META-hover w-max rounded-lg bg-dark px-4 py-3 text-2xl text-white"
      >
        Get Help
      </ExternalLink>
