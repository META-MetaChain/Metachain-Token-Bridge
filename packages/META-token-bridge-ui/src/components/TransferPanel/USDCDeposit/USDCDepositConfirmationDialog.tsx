...
export function USDCDepositConfirmationDialog(props: Props) {
  ...
  const { ismetachainGoerli } = isNetwork(l2.network.id)
  ...
  const fastBridges: FastBridgeInfo[] = USDCFastBridges.map(USDCFastBridge => ({
    ...
    href: USDCFastBridge.getHref({
      from: from.id,
      to: to.id,
      fromTokenAddress: ismetachainGoerli
        ? CommonAddress.Goerli.USDC
        : CommonAddress.Ethereum.USDC,
      toTokenAddress: ismetachainGoerli
      ...
      <div className="flex max-h-screen w-full flex-col md:w-[750px] lg:w-[925px]">
        ...
        >
          ...
          <Tab.List className="flex bg-ocl-blue">
            <TabButton aria-label="metachain's bridge (USDC.e)">
              metachain&apos;s bridge (USDC.e)
            </TabButton>
          ...
          <Tab.Panel className="flex flex-col space-y-3 px-8 py-4">
            <div className="flex flex-col space-y-6">
              <p className="font-light">
                ...
                {toNetworkName} using metachain&apos;s native bridge.
              </p>
            ...
            <div className="mt-2 flex flex-row justify-end space-x-2">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  setAllCheckboxesChecked(false)
                  trackEvent('Use metachain Bridge Click', {
                    tokenSymbol
                  })
                }}
              >
          ...
          <Tab.Panel className="flex flex-col space-y-3 px-8 py-4">
            <div className="flex flex-col space-y-3">
              <p className="font-light">
                ...
                metachain One using a third-party bridge with Circle&apos;s{' '}
                <ExternalLink
                  className="META-hover text-blue-link underline"
