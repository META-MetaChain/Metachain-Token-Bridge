...
export function USDCDepositConfirmationDialogCheckbox({
  ...
  const externalLinkClassnames = 'META-hover text-blue-link underline'
          ...
          <Checkbox
            label={
              <span className="select-none font-light">
                ...
                {isTestnet ? 'metachain Goerli' : 'metachain One'}.
              </span>
            }
        ...
        label={
          <span className="select-none font-light">
            ...
            <ExternalLink
              ...
              href="https://metachainfoundation.medium.com/usdc-to-come-natively-to-metachain-f751a30e3d83"
