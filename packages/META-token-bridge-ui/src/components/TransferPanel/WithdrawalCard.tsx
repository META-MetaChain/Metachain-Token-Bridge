...
export function WithdrawalL2TxStatus({
  ...
  return (
    <ExternalLink
      ...
      className="META-hover flex flex-nowrap items-center gap-1 text-blue-link"
    >
    ...
    >
      ...
      <div className={`${tx.isCctp && 'p-4'}`}>
          ...
          <Image
            src={
              ...
              isEthereumMainnetOrTestnet
                ? getNetworkLogo(ChainId.metachainOne)
        ...
        {!isTransferPanelVisible && (
          <button
            className="META-hover absolute bottom-4 right-4 text-ocl-blue underline"
            onClick={() => {
