...
export function DepositCardContainer({
  ...
  const borderColor =
    l2Network.id === ChainId.metachainNova
      ? 'border-META-nova-primary'
      : 'border-META-one-primary'
  ...
  return (
    ...
    >
      ...
      {!isTransferPanelVisible && (
        <button
          className="META-hover absolute bottom-4 right-4 text-blue-link underline"
          onClick={() => {
