...
import { addCustomChain } from '@metachain/sdk'
...
const orbitConfigsLocalStorageKey = 'metachain:orbit:configs'
        ...
        <div className="relative">
          <pre className="scroll mb-2 max-h-[400px] overflow-auto rounded-lg border border-white/20 bg-white/5 p-4 text-sm text-error">
            <button
              ...
              className="META-hover absolute right-4 top-4 text-white"
            >
              <XMarkIcon width={24} />
            </button>
            {error}
