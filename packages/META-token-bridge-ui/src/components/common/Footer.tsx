...
const footerLinks: FooterLink[] = [
  ...
  {
    title: 'Careers',
    href: 'https://META-MetaChain.com/careers',
    className: 'lg:order-2'
  },
  {
    title: 'Blog',
    href: 'https://medium.com/meta-research',
    className: 'lg:order-4'
  },
  {
    title: 'Recent Press',
    href: 'https://META-MetaChain.com/#press',
    className: 'lg:order-5'
  },
  {
    title: 'ToS',
    href: 'https://metachain-i.co/tos',
    className: 'lg:order-3'
  },
  {
    title: 'Privacy Policy',
    href: 'https://metachain-i.co/privacy',
          ...
          <ul className="grid text-center font-light lg:max-w-[500px] lg:grid-cols-3 lg:grid-rows-2 lg:text-left lg:font-normal">
            {footerLinks.map(link => (
              <li key={link.href} className={link.className}>
                <ExternalLink href={link.href} className="META-hover">
                  {link.title}
                </ExternalLink>
              </li>
            ))}
