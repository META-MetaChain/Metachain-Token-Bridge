...
export function HeaderAccountPopover({
  ...
  const headerItemsClassName =
    'META-hover flex w-full flex-row items-center space-x-2 px-12 py-2 text-lg lg:text-sm font-light text-white hover:bg-ocl-blue lg:px-4'

  return (
    <Popover className="relative z-50 w-full lg:w-max">
      <Popover.Button
        className="META-hover flex w-full justify-start rounded-full px-6 py-3 lg:w-max lg:p-0"
        role="button"
