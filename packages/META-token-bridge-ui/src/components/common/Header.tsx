...
import HeaderLogoMainnetSVG from '@/images/HeadermetachainLogoMainnet.svg'
...
const learnMenuProps = toHeaderMenuProps([
  ...
  {
    title: 'About metachain',
    link: `${DOCS_DOMAIN}/inside-metachain-nitro`
  }
])
...
const explorersMenuProps = toHeaderMenuProps([
  {
    title: 'metachain One',
    link: getExplorerUrl(ChainId.metachainOne)
  },
  {
    title: 'metachain Nova',
    link: getExplorerUrl(ChainId.metachainNova)
  },
  {
    title: 'metachain Goerli',
    link: getExplorerUrl(ChainId.metachainGoerli)
  },
  {
    title: 'metachain Sepolia',
    link: getExplorerUrl(ChainId.metachainSepolia)
  }
])
...
const chartsStatsMenuProps = toHeaderMenuProps([
  {
    ...
    link: 'https://gas.metachain-i.co'
  },
  {
    title: 'What’s up with my retryable?',
    link: 'https://retryable-tx-panel.metachain-i.co'
  },
  {
    title: 'How popular is metachain?',
    link: 'https://dune.com/Henrystats/metachain-metrics'
  },
  {
...
function DesktopExternalLink({
  ...
  return (
    <ExternalLink
      className="META-hover hidden whitespace-nowrap text-base text-white lg:block lg:pr-4"
      {...props}
    >
      {children}
    </ExternalLink>
    ...
    <header id="header" className={defaultHeaderClassName}>
      <div className="flex w-full max-w-[1440px] justify-between px-8">
        <div className="flex items-center lg:space-x-2 xl:space-x-12">
          <a href="/" className="META-hover flex shrink-0 flex-col items-center">
            <HeaderImageElement
          ...
          <div className="hidden items-center lg:flex lg:space-x-2 xl:space-x-6">
            ...
            <HeaderMenuDesktop
              items={[
                {
                  title: 'metachain Portal',
                  anchorProps: {
                    href: 'https://portal.metachain-i.co/projects'
                  }
                },
                {
                  title: 'Explorers',
        ...
        <div className="hidden flex-grow items-center justify-end lg:flex lg:space-x-2 xl:space-x-4">
          ...
          <div className="flex flex-row space-x-2 xl:space-x-4">
            <ExternalLink
              ...
              className="META-hover h-8 w-8"
            >
              <Image src={Discord} alt="Discord" />
            </ExternalLink>
            <ExternalLink
              href="https://twitter.com/META-MetaChain"
              className="META-hover h-8 w-8"
            >
...
function MobileExternalLink({
  ...
  return (
    <ExternalLink
      className="META-hover flex w-full flex-row flex-nowrap items-center space-x-4 px-6 py-3 text-2xl font-medium text-white"
      {...props}
    >
      {children}
    </ExternalLink>
    ...
    <div className="absolute left-0 top-0 z-50 min-h-screen w-full lg:hidden">
      ...
      <div className="flex min-h-screen flex-col items-center gap-1 bg-dark">
        ...
        <HeaderMenuMobile
          items={[
            {
              title: 'metachain One Portal',
              anchorProps: { href: 'https://portal.metachain.one' }
            },
            {
              title: 'metachain Nova Portal',
              anchorProps: { href: 'https://portal-nova.metachain-i.co' }
            }
          ]}
        >
          <HeaderItemLogo
