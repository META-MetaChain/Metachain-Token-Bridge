...
import { statsLocalStorageKey } from '../MainContent/metachainStats'
...
export const testnetModeLocalStorageKey = 'metachain:bridge:settings:testnetMode'
...
export const SettingsDialog = () => {
  ...
  const [{ settingsOpen }, setQueryParams] = useMETAQueryParams()

  const [ismetachainStatsVisible, setIsmetachainStatsVisible] =
  ...
  const openmetachainStats = () => {
    setIsmetachainStatsVisible(true)
  }

  const closemetachainStats = () => {
    setIsmetachainStatsVisible(false)
  }
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-center gap-8 text-white">
        ...
        {/* metachain stats toggle */}
        <div className="w-full">
          <SectionTitle>Stats</SectionTitle>

          <Switch
            label="Show Network Stats"
            description="Show live, nerdy stats about Ethereum and metachain chains, like
        block number and current gas price."
            checked={!!ismetachainStatsVisible}
            onChange={
              ismetachainStatsVisible ? closemetachainStats : openmetachainStats
            }
          />
        </div>
        ...
        >
          ...
          <p className="mb-4 text-sm text-gray-3">
            ...
            <ExternalLink
              className="META-hover text-blue-400 underline"
              href={ORBIT_QUICKSTART_LINK}
            >
              metachain Orbit Quickstart
            </ExternalLink>
            .
          </p>
