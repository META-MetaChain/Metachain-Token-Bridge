...
export function HeaderMenuDesktop(
  ...
  return (
    <Popover as="div" className="relative inline-block text-left">
      <div>
        <Popover.Button className="META-hover hidden items-center whitespace-nowrap rounded-md text-base text-white lg:inline-flex lg:p-1">
          {props.children}
    ...
    <Disclosure>
      {({ open }) => (
        <div className="w-full">
          <Disclosure.Button
            className={`META-hover flex w-full items-center justify-start px-6 py-3 ${
              open && `bg-white`
            }`}
          >
            <span
