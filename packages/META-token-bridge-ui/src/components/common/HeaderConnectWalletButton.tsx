  ...
  if (!connected) {
    return (
      <button
        ...
        type="button"
        className="META-hover flex w-full flex-row items-center bg-lime-dark px-6 py-3 text-2xl font-medium text-white lg:rounded-full lg:bg-lime-dark lg:px-4 lg:py-2 lg:text-base lg:font-normal"
      >
  ...
  if (chainUnsupported) {
    return (
      <button
        ...
        type="button"
        className="META-hover flex w-full flex-row items-center bg-[#FF494A] bg-lime-dark px-6 py-3 text-2xl font-medium text-white lg:rounded-full lg:px-4 lg:py-2 lg:text-base lg:font-normal"
      >
        Wrong network
      </button>
    )
