...
export const TransactionHistory = ({
  ...
  const roundedTabClasses =
    'roundedTab ui-not-selected:META-hover relative flex flex-row flex-nowrap items-center gap-0.5 md:gap-2 rounded-tl-lg rounded-tr-lg px-2 md:px-4 py-2 text-base ui-selected:bg-white ui-not-selected:text-white justify-center md:justify-start grow md:grow-0'
  ...
  useEffect(() => {
    // This check avoid the situation when we open the transaction history on CCTP tab after a transfer, but it would go back to "To metachain" tab
