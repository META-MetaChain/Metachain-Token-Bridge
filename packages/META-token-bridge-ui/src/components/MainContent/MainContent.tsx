...
import { metachainStats, statsLocalStorageKey } from './metachainStats'
...
export function MainContent() {
  ...
  useEffect(() => {
    ...
    METATokenBridge?.transactions?.setDepositsInStore?.(
  ...
  useEffect(() => {
    ...
    METATokenBridge?.setWithdrawalsInStore?.(withdrawalsData.pendingWithdrawals)
  ...
  return (
    <div className="flex w-full justify-center">
      <div className="main-panel w-full max-w-screen-lg flex-col space-y-6">
        <div className="hidden text-center text-5xl">metachain Token Bridge</div>
      ...
      {ismetachainStatsVisible && <metachainStats />}
    </div>
  )
}
